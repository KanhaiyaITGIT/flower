...
const Home = () => {
  ...
  // Countdown timer for the Deal of the Day
  useEffect(() => {
  ...
  return (
    <>
      {/* ─── Announcement Bar ─── */}
      <div className="bg-rose-500 text-white text-center text-xs md:text-sm font-medium">
        <div className="max-w-7xl mx-auto px-6 py-2.5 flex items-center justify-center gap-2 md:gap-6 flex-wrap">
          ...
          <span className="hidden md:inline-flex items-center gap-1.5">
            <Truck size={14} />
            Same-day delivery across Gurgaon
          </span>
          <span className="hidden lg:inline opacity-50">•</span>
          <span className="hidden lg:inline-flex items-center gap-1.5">
            <Gift size={14} />
            Free greeting card with every order
          </span>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                ...
                <button className="inline-flex items-center gap-2 bg-white border border-gray-200 px-8 py-4 rounded-full font-semibold hover:shadow-md transition">
            ...
            <div className="relative">
              ...
              <div className="hidden lg:flex absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl px-5 py-4 items-center gap-3 z-20">
                <div className="flex -space-x-3">
                  ...
                  <div className="w-9 h-9 rounded-full bg-purple-400 border-2 border-white flex items-center justify-center text-white text-xs font-bold">
                    N
                  </div>
                </div>
                <div>
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-bold text-sm text-slate-900">4.9</span>
                  </div>
              ...
              >
                <div className="overflow-hidden h-72 relative">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-white/90 backdrop-blur flex items-center justify-center shadow-md hover:scale-110 transition"
                  >
                    <Heart
                      size={18}
                      className={
      ...
      <section className="py-24 bg-gradient-to-r from-rose-100 via-pink-50 to-purple-100">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-gray-600 mt-4">
            Subscribe for exclusive offers, flower care tips and early access
