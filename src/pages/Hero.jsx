...
//       a: "Place your order before 4 PM and we'll deliver fresh flowers to your doorstep the same day, across Gurgaon.",
//     },
//     {
...
//                 Handcrafted bouquets, luxury floral arrangements and meaningful
...
//               <div
//                 key={index}
//                 className="group rounded-3xl overflow-hidden bg-white shadow-lg hover:-translate-y-2 transition-all duration-300"
//               >
...
//               </span>
//               <h2 className="text-4xl md:text-5xl font-bold font-serif mt-6">
//                 Sunset Rose Grand Bouquet
//               </h2>
//               <p className="text-white/60 mt-4 leading-relaxed max-w-md">
//                 A breathtaking arrangement of 50 premium roses in warm sunset
//                 hues, finished with eucalyptus and a hand-tied silk ribbon.
//               </p>
...
//                 >
//                   <span className="text-3xl font-bold text-rose-400 hover:text-rose-500 transition">
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="mt-10 inline-flex items-center gap-2 bg-rose-500 hover:bg-rose-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg shadow-rose-500/30 hover:scale-105 transition"
//               >
...
//             <p className="text-gray-500 mt-4">
//               From our garden to your doorstep, in three simple steps
//             </p>
//           </div>
...
//                 <div
//                   key={index}
//                   className="relative bg-white rounded-3xl p-8 pt-12 shadow-lg text-center"
//                 >
//                   <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-5xl font-bold text-rose-100 font-serif">
//                     {pad(index + 1)}
//                   </span>
...
//                 <div
//                   key={index}
//                   className={`${item.bg} p-8 rounded-3xl text-center hover:-translate-y-1.5 transition-all duration-300`}
//                 >
...
//                   <div
//                     className={`w-11 h-11 rounded-full ${item.color} flex items-center justify-center text-white font-bold`}
//                   >
//                     {item.initials}
//                   </div>
//                   <div>
...
//           <h2 className="text-4xl font-bold font-serif mt-6">
//             Join Our Flower Family
//           </h2>
//           <p className="text-gray-600 mt-4">
//             Subscribe for exclusive offers, flower care tips and early access to
...
//               <CheckCircle2 size={20} /> Welcome to the family! Check your inbox
//               soon.
//             </div>
//           ) : (
...
//                 className="bg-rose-500 hover:bg-rose-600 text-white px-8 py-4 rounded-full font-semibold transition"
//               >
//                 Subscribe
//               </button>
//             </div>
...
//               className="w-11 h-11 rounded-full bg-white flex items-center justify-center text-rose-500 shadow-sm hover:-translate-y-1 transition"
//             >
//               <FaInstagram size={18} />
//             </a>
//             <a
...
const Home = () => {
  ...
  const scrollSlider = (ref, direction) => {
    ...
    const cardWidth = card ? card.offsetWidth + 24 : 300; // gap-6 = 24px
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50">
        ...
        <div className="max-w-[85%] mx-auto px-6 py-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* LEFT */}
            <div className="relative z-10 order-2 lg:order-none">
              <div className="inline-flex items-center gap-2 bg-white shadow-md px-4 py-2 rounded-full text-sm font-semibold text-rose-500">
                <Leaf size={14} />
                Handpicked Fresh, Every Morning
              </div>
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                <Link
                  to="/category"
                  className="inline-flex items-center gap-2 bg-rose-500 hover:bg-rose-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:scale-105 transition"
                >
                  <ShoppingBag size={18} />
                  Shop Collection
                </Link>
            ...
            <div className="relative order-1 lg:order-none">
              <div className="relative">
                <img
                  ...
                  className="rounded-[40px] shadow-2xl w-full object-cover"
                />
                <div className="absolute bottom-4 left-1 bg-white px-5 py-4 rounded-3xl shadow-xl">
                  <p className="font-bold text-lg">10,000+</p>
                  <p className="text-gray-500 text-sm">Happy Customers</p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="hidden  absolute -left-4 lg:-left-6 top-1/2 -translate-y-1/2 z-10 w-11 h-11 rounded-full bg-white shadow-lg items-center justify-center text-slate-700 hover:bg-rose-500 hover:text-white transition-colors duration-200"
            ...
            <div
              ...
              className="flex md:grid md:grid-cols-4 gap-6 overflow-x-auto md:overflow-visible snap-x snap-mandatory scroll-smooth pb-4 md:pb-0 scrollbar-hide"
            >
              {categories.map((item, index) => (
                <div
                  key={index}
                  ...
                  className="group rounded-3xl overflow-hidden bg-white shadow-lg hover:-translate-y-2 transition-all duration-300 cursor-pointer shrink-0 w-[78vw] sm:w-[320px] md:w-auto snap-start"
                >
                  <div className="h-64 overflow-hidden relative">
                    <img
                      src={item.image}
                    ...
                    <Link
                      ...
                      className="absolute bottom-4 left-1/2 -translate-x-1/2 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 bg-white text-rose-500 font-semibold px-5 py-2.5 rounded-full text-sm flex items-center gap-2 shadow-lg whitespace-nowrap"
                    >
                      Shop Now <ArrowRight size={14} />
                    </Link>
                  </div>
                  <div className="p-5">
                    ...
                    <Link
                      to={`/category?cat=${encodeURIComponent(item.category)}`}
                      onClick={(e) => e.stopPropagation()}
                      className="md:hidden mt-4 w-full bg-rose-500 text-white font-semibold px-5 py-2.5 rounded-full text-sm flex items-center justify-center gap-2 shadow-md hover:bg-rose-600 transition"
                    >
            ...
            <button
              ...
              className="hidden  absolute -right-4 lg:-right-6 top-1/2 -translate-y-1/2 z-10 w-11 h-11 rounded-full bg-white shadow-lg items-center justify-center text-slate-700 hover:bg-rose-500 hover:text-white transition-colors duration-200"
            ...
            >
              {bestSellers.map((item) => (
                <div
                  key={item.id}
                  data-slide-card
                  className="bg-white rounded-3xl overflow-hidden shadow-lg hover:-translate-y-2 transition-all duration-300 shrink-0 w-[78vw] sm:w-[300px] md:w-auto snap-start"
                >
                  <div className="overflow-hidden h-72 relative">
                    {item.badge && (
                      <div className="absolute top-4 left-4 z-10 bg-rose-500 text-white text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-wide">
                  ...
                  <div className="p-5">
                    ...
                    <Link
                      to={`/category?cat=${encodeURIComponent(item.category)}`}
                      className="mt-4 w-full bg-rose-500 text-white py-3 rounded-xl font-medium hover:bg-rose-600 transition flex items-center justify-center"
                    >
                      Quick View
                    </Link>
                  </div>
