                    ...
                    >
                      {sortOptions.map((opt) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-2.5 text-xs font-bold tracking-wider uppercase transition-colors hover:bg-rose-50 hover:text-[#D6537A] ${
                            sortBy === opt.value ? "text-[#D6537A] bg-[#F4C9D1]/40" : "text-gray-600"
                          }`}
                        >
                          {opt.label}
                        </button>
